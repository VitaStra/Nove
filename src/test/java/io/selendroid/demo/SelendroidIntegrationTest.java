...
public class SelendroidIntegrationTest {
  ...
  public void testShouldBeAbleToEnterText() {
    WebElement inputField = driver.findElement(By.id("startUserRegistration"));
    inputField.click();
    WebElement username = driver.findElement(By.id("inputUsername"));
    //driver.findElement(By.id("inputUsername"));
    username.sendKeys("uuu");
    //inputField.sendKeys("Selendroid");
    Assert.assertEquals("uuuu", username.getText());
  }
  ...
  public static void startSelendroidServer() throws Exception {
    ...
    //caps.setLaunchActivity("io.selendroid.testapp.RegisterUserActivity");
